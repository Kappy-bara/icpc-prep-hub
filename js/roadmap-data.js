 ...
 * Each topic: { id, name, what, why, resource: { label, url } | null }
 * `what` is a plain definition (what the technique actually is); `why` is the motivation
 * (why it matters for ICPC). `id` must be globally unique (subject.topic-slug) since it's
 * the localStorage key for checkbox state.
 */
const ROADMAP = [
  {
    id: "math",
