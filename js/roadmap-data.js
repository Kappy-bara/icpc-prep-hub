    ...
    phases: [
      {
        ...
        topics: [
          ...
          },
          {
            ...
            name: "Bitwise operations & bit manipulation",
            what: "Working directly with the binary representation of numbers using AND, OR, XOR, and shifts — including tricks like checking if a number is a power of 2, isolating the lowest set bit, or iterating over subsets.",
            hitScore: 5,
            why: "The foundation for bitmask DP, Fenwick trees, and solving any problem involving subsets or XOR.",
            resource: { label: "USACO Guide: Bitwise Operators", url: "https://usaco.guide/silver/intro-bitwise" },
          },
          {
    ...
    phases: [
      {
        ...
        topics: [
          ...
          {
            id: "greedy.ternary-search",
            name: "Ternary search",
            what: "Finding the minimum or maximum of a unimodal function by splitting the search space into three parts and discarding one third at each step.",
            hitScore: 3,
            why: "When you need to optimize a function that goes up then down (or down then up) instead of just crossing a binary threshold.",
            resource: { label: "cp-algorithms: Ternary Search", url: "https://cp-algorithms.com/num_methods/ternary_search.html" },
          },
          {
    ...
    phases: [
      {
        ...
        topics: [
          ...
          {
            id: "meta.ad-hoc",
            name: "Ad hoc & Constructive algorithms",
            what: "Problems that require no standard algorithm or data structure, just pure case analysis, logic, or constructing a specific output that satisfies given rules.",
            hitScore: 5,
            why: "Almost all Div2 A and B problems fall into this category. They test raw problem-solving and coding speed rather than textbook knowledge.",
            resource: { label: "Codeforces EDU: courses", url: "https://codeforces.com/edu/courses" },
          },
        ],
      },
      {
        ...
        topics: [
          ...
          },
          {
            ...
            what: "Problems where the input isn't given all at once, but revealed through interacting with a grader program — asking questions and receiving answers in real-time.",
            hitScore: 3,
            why: "A modern ICPC and Codeforces staple that requires careful flushing of I/O streams and reasoning about adversarial worst-case bounds.",
            resource: { label: "Codeforces: Interactive Problems Guide", url: "https://codeforces.com/blog/entry/45307" },
          },
        ],
      },
      {
